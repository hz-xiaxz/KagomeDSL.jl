...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/hz-xiaxz/KagomeDSL.jl
   ```
...
- After that runs, the [stable docs](https://hz-xiaxz.github.io/KagomeDSL.jl/stable) should be updated. Check them and look for the version number.
